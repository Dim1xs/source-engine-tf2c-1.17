...
#include "tdc_emissive_scroll_blended_pass_helper.h"
#include "convar.h"

#include "tdc_emissive_scroll_blended_pass_vs30.inc"
#include "tdc_emissive_scroll_blended_pass_ps30.inc"
								   ...
								   IShaderShadow* pShaderShadow, EmissiveScrollBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		DECLARE_STATIC_VERTEX_SHADER( tdc_emissive_scroll_blended_pass_vs30 );
		SET_STATIC_VERTEX_SHADER( tdc_emissive_scroll_blended_pass_vs30 );

		DECLARE_STATIC_PIXEL_SHADER( tdc_emissive_scroll_blended_pass_ps30 );
		SET_STATIC_PIXEL_SHADER( tdc_emissive_scroll_blended_pass_ps30 );
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( tdc_emissive_scroll_blended_pass_vs30 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING, pShaderAPI->GetCurrentNumBones() > 0 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( MORPHING, pShaderAPI->IsHWMorphingEnabled() );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
		SET_DYNAMIC_VERTEX_SHADER( tdc_emissive_scroll_blended_pass_vs30 );

		DECLARE_DYNAMIC_PIXEL_SHADER( tdc_emissive_scroll_blended_pass_ps30 );
		SET_DYNAMIC_PIXEL_SHADER( tdc_emissive_scroll_blended_pass_ps30 );
