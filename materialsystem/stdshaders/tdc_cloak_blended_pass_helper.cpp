...
#include "tdc_cloak_blended_pass_helper.h"
#include "convar.h"

#include "tdc_cloak_blended_pass_vs30.inc"
#include "tdc_cloak_blended_pass_ps30.inc"
						  ...
						  IShaderShadow* pShaderShadow, CloakBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	...
	SHADOW_STATE
	{
		...
		// Vertex Shader
		DECLARE_STATIC_VERTEX_SHADER( tdc_cloak_blended_pass_vs30 );
		SET_STATIC_VERTEX_SHADER_COMBO( BUMPMAP, bBumpMapping ? 1 : 0 );
		SET_STATIC_VERTEX_SHADER( tdc_cloak_blended_pass_vs30 );

		// Pixel Shader
		DECLARE_STATIC_PIXEL_SHADER( tdc_cloak_blended_pass_ps30 );
		SET_STATIC_PIXEL_SHADER_COMBO( BUMPMAP, bBumpMapping ? 1 : 0 );
		SET_STATIC_PIXEL_SHADER( tdc_cloak_blended_pass_ps30 );
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( tdc_cloak_blended_pass_vs30 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING, pShaderAPI->GetCurrentNumBones() > 0 );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( MORPHING, pShaderAPI->IsHWMorphingEnabled() );
		SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
		SET_DYNAMIC_VERTEX_SHADER( tdc_cloak_blended_pass_vs30 );

		// Set Pixel Shader Combos
		DECLARE_DYNAMIC_PIXEL_SHADER( tdc_cloak_blended_pass_ps30 );
		SET_DYNAMIC_PIXEL_SHADER( tdc_cloak_blended_pass_ps30 );
