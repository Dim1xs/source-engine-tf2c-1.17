...
#include "tdc_flesh_interior_blended_pass_vs30.inc"
#include "tdc_flesh_interior_blended_pass_ps30.inc"
								  ...
								  IShaderShadow* pShaderShadow, FleshInteriorBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		// Vertex Shader
		DECLARE_STATIC_VERTEX_SHADER( tdc_flesh_interior_blended_pass_vs30 );
		SET_STATIC_VERTEX_SHADER_COMBO( HALFLAMBERT, IS_FLAG_SET( MATERIAL_VAR_HALFLAMBERT ) );
		SET_STATIC_VERTEX_SHADER( tdc_flesh_interior_blended_pass_vs30 );
		
		DECLARE_STATIC_PIXEL_SHADER( tdc_flesh_interior_blended_pass_ps30 );
		SET_STATIC_PIXEL_SHADER( tdc_flesh_interior_blended_pass_ps30 );
	...
	DYNAMIC_STATE
	{
		...
		DECLARE_DYNAMIC_VERTEX_SHADER( tdc_flesh_interior_blended_pass_vs30 );
		...
		SET_DYNAMIC_VERTEX_SHADER( tdc_flesh_interior_blended_pass_vs30 );
		...
		DECLARE_DYNAMIC_PIXEL_SHADER( tdc_flesh_interior_blended_pass_ps30 );
		SET_DYNAMIC_PIXEL_SHADER( tdc_flesh_interior_blended_pass_ps30 );
