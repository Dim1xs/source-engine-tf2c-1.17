...
projects={
	'game': [
		...
		'materialsystem/stdshaders/game_shader_dx9',
		'mathlib',
		'particles',
		'scenefilecache',
		'serverbrowser',
...
def options(opt):
	...
	grp.add_option('--build-games', action = 'store', dest = 'GAMES', type = 'string', default = 'tdc',
