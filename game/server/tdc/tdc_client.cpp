...
void FinishClientPutInServer( CTDCPlayer *pPlayer )
{
	{
...
void ClientPutInServer( edict_t *pEdict, const char *playername )
{
	...
	CTDCPlayer *pPlayer = CTDCPlayer::CreatePlayer( "player", pEdict );
...
void ClientActive( edict_t *pEdict, bool bLoadGame )
{
	...
	CTDCPlayer *pPlayer = ToTDCPlayer( CBaseEntity::Instance( pEdict ) );
...
{
	CreateGameRulesObject( "CTDCGameRules" );
}
