...
//===========================
	...
	// Rocketlauncher.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_ROCKETLAUNCHER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_ROCKETLAUNCHER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_ROCKETLAUNCHER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_ROCKETLAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ROCKETLAUNCHER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ROCKETLAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER_END );

	// Grenadelauncher.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_GRENADELAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_GRENADELAUNCHER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_GRENADELAUNCHER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_GRENADELAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_GRENADELAUNCHER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_GRENADELAUNCHER );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_GRENADELAUNCHER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_GRENADELAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_GRENADELAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_GRENADELAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_GRENADELAUNCHER_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER_END );

	// Super Shotgun.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_SUPERSHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_SUPERSHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_SUPERSHOTGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_SUPERSHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_SUPERSHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_SUPERSHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_SUPERSHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_SUPERSHOTGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_SUPERSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_SUPERSHOTGUN );

	// AssaultRifle.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_ASSAULTRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_ASSAULTRIFLE );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_ASSAULTRIFLE );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_ASSAULTRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_ASSAULTRIFLE );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_ASSAULTRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_ASSAULTRIFLE );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_ASSAULTRIFLE );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_ASSAULTRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_ASSAULTRIFLE );

	// LeverRifle.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_LEVERRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_DEPLOYED_IDLE_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_DEPLOYED_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_DEPLOYED_IDLE_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_DEPLOYED_LEVERRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_LEVERRIFLE );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_LEVERRIFLE );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_LEVERRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_SECONDARYATTACK_STAND_LEVERRIFLE );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_SECONDARYATTACK_CROUCH_LEVERRIFLE );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_SECONDARYATTACK_SWIM_LEVERRIFLE );
	ADD_ACTIVITY_TO_SR( ACT_MP_SECONDARYATTACK_AIRWALK_LEVERRIFLE );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_LEVERRIFLE );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_LEVERRIFLE );

	// SuperNailgun.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_SUPERNAILGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_SUPERNAILGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_SUPERNAILGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_SUPERNAILGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_SUPERNAILGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_SUPERNAILGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_SUPERNAILGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_SUPERNAILGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_SUPERNAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_SUPERNAILGUN );

	// Flamethrower.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_FLAMETHROWER );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_FLAMETHROWER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_FLAMETHROWER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_FLAMETHROWER );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_PREFIRE_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_POSTFIRE_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_PREFIRE_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_POSTFIRE_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_PREFIRE_FLAMETHROWER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_POSTFIRE_FLAMETHROWER );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_FLAMETHROWER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_FLAMETHROWER );

	// Chainsaw.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_CHAINSAW );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_CHAINSAW );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_CHAINSAW );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_CHAINSAW );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_PREFIRE_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_POSTFIRE_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_PREFIRE_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_POSTFIRE_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_PREFIRE_CHAINSAW );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_POSTFIRE_CHAINSAW );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_CHAINSAW );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_CHAINSAW );

	// HuntingShotgun.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_HUNTINGSHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_HUNTINGSHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_HUNTINGSHOTGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_HUNTINGSHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_HUNTINGSHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_HUNTINGSHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN_END );
	...
	// Shotgun.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_SHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_SHOTGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_SHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_SHOTGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_SHOTGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_SHOTGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_SHOTGUN_END );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_SHOTGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_SHOTGUN_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_SHOTGUN_END );

	// Pistol.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_PISTOL );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_PISTOL );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_PISTOL );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_PISTOL );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_PISTOL );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_PISTOL );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_PISTOL );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_PISTOL );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_PISTOL );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_PISTOL );

	// Sten.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_STEN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_STEN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_STEN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_STEN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_STEN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_STEN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_STEN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_STEN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_STEN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_STEN );

	// Revolver.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_REVOLVER );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_REVOLVER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_REVOLVER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_REVOLVER );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_REVOLVER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_REVOLVER );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_REVOLVER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_REVOLVER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_REVOLVER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_REVOLVER );

	// Nailgun.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_NAILGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_NAILGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_NAILGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_NAILGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_NAILGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_NAILGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_NAILGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_NAILGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_NAILGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_NAILGUN );

	// Flaregun.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_FLAREGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_FLAREGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_FLAREGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_FLAREGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_FLAREGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_FLAREGUN );

	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_STAND_FLAREGUN );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_CROUCH_FLAREGUN );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_SWIM_FLAREGUN );
	ADD_ACTIVITY_TO_SR( ACT_MP_RELOAD_AIRWALK_FLAREGUN );

	// Remotebomb.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_REMOTEBOMB );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_REMOTEBOMB );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_REMOTEBOMB );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_REMOTEBOMB );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_REMOTEBOMB );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_REMOTEBOMB );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_REMOTEBOMB );

	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_REMOTEBOMB_ALT );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_REMOTEBOMB_ALT );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_REMOTEBOMB_ALT );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_REMOTEBOMB_ALT );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_REMOTEBOMB_ALT );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_REMOTEBOMB_ALT );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_REMOTEBOMB_ALT );
	...
	// Displacer.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_DISPLACER );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_DISPLACER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_DISPLACER );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_DISPLACER );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_DISPLACER );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_DISPLACER );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_DISPLACER );
	...
	// Crowbar.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_CROWBAR );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_CROWBAR );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_CROWBAR );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_CROWBAR );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_CROWBAR );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_CROWBAR );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_CROWBAR );
	...
	// Flag.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_FLAG );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_FLAG );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_FLAG );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_FLAG );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_FLAG );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_FLAG );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_FLAG );

	// Hammerfists.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_HAMMERFISTS );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_HAMMERFISTS );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_HAMMERFISTS );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_HAMMERFISTS );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_HAMMERFISTS );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_HAMMERFISTS );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_HAMMERFISTS );

	// Claws.
	ADD_ACTIVITY_TO_SR( ACT_MP_STAND_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCH_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_RUN_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_AIRWALK_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_CROUCHWALK_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_START_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_FLOAT_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_JUMP_LAND_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_SWIM_CLAWS );

	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_STAND_CLAWS );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_CROUCH_CLAWS );        // CROUCHWALK
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_SWIM_CLAWS );
	ADD_ACTIVITY_TO_SR( ACT_MP_ATTACK_AIRWALK_CLAWS );

	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_STAND_CLAWS );        // RUN, WALK
	ADD_ACTIVITY_TO_SR( ACT_MP_DRAW_CROUCH_CLAWS );
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_LAST );
