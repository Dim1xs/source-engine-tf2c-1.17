...
// Team Fortress specific - medic heal, medic infect, etc.....
    ...
    // Rocketlauncher.
    ACT_MP_STAND_ROCKETLAUNCHER,
    ACT_MP_CROUCH_ROCKETLAUNCHER,
    ACT_MP_RUN_ROCKETLAUNCHER,
	ACT_MP_SLIDE_ROCKETLAUNCHER,			//LIGHT GRUNT SLIDE
	ACT_MP_TACKLE_ROCKETLAUNCHER,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_ROCKETLAUNCHER,
    ACT_MP_CROUCHWALK_ROCKETLAUNCHER,
    ACT_MP_JUMP_START_ROCKETLAUNCHER,
    ACT_MP_JUMP_FLOAT_ROCKETLAUNCHER,
    ACT_MP_JUMP_LAND_ROCKETLAUNCHER,
    ACT_MP_SWIM_ROCKETLAUNCHER,
 
    ACT_MP_ATTACK_STAND_ROCKETLAUNCHER,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_ROCKETLAUNCHER,			//SLIDE
	ACT_MP_ATTACK_TACKLE_ROCKETLAUNCHER,			//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_ROCKETLAUNCHER,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_ROCKETLAUNCHER,
    ACT_MP_ATTACK_AIRWALK_ROCKETLAUNCHER,
 
    ACT_MP_DRAW_STAND_ROCKETLAUNCHER,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_ROCKETLAUNCHER,		//SLIDE
    ACT_MP_DRAW_CROUCH_ROCKETLAUNCHER,
 
    ACT_MP_RELOAD_STAND_ROCKETLAUNCHER,        // RUN, WALK
    ACT_MP_RELOAD_STAND_ROCKETLAUNCHER_LOOP,
    ACT_MP_RELOAD_STAND_ROCKETLAUNCHER_END,
	ACT_MP_RELOAD_SLIDE_ROCKETLAUNCHER,        // SLIDE
    ACT_MP_RELOAD_SLIDE_ROCKETLAUNCHER_LOOP,
    ACT_MP_RELOAD_SLIDE_ROCKETLAUNCHER_END,
    ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER,        // CROUCHWALK
    ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER_LOOP,
    ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER_END,
    ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER,
    ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER_LOOP,
    ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER_END,
    ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER,
    ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER_LOOP,
    ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER_END,
 
    // GRENADELAUNCHER.
    ACT_MP_STAND_GRENADELAUNCHER,
    ACT_MP_CROUCH_GRENADELAUNCHER,
    ACT_MP_RUN_GRENADELAUNCHER,
	ACT_MP_SLIDE_GRENADELAUNCHER,			//LIGHT GRUNT SLIDE
	ACT_MP_TACKLE_GRENADELAUNCHER,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_GRENADELAUNCHER,
    ACT_MP_CROUCHWALK_GRENADELAUNCHER,
    ACT_MP_JUMP_START_GRENADELAUNCHER,
    ACT_MP_JUMP_FLOAT_GRENADELAUNCHER,
    ACT_MP_JUMP_LAND_GRENADELAUNCHER,
    ACT_MP_SWIM_GRENADELAUNCHER,
 
    ACT_MP_ATTACK_STAND_GRENADELAUNCHER,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_GRENADELAUNCHER,			//SLIDE
	ACT_MP_ATTACK_TACKLE_GRENADELAUNCHER,			//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_GRENADELAUNCHER,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_GRENADELAUNCHER,
    ACT_MP_ATTACK_AIRWALK_GRENADELAUNCHER,
 
    ACT_MP_DRAW_STAND_GRENADELAUNCHER,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_GRENADELAUNCHER,		//SLIDE
    ACT_MP_DRAW_CROUCH_GRENADELAUNCHER,
 
    ACT_MP_RELOAD_STAND_GRENADELAUNCHER,        // RUN, WALK
    ACT_MP_RELOAD_STAND_GRENADELAUNCHER_LOOP,
    ACT_MP_RELOAD_STAND_GRENADELAUNCHER_END,
	ACT_MP_RELOAD_SLIDE_GRENADELAUNCHER,        // SLIDE
    ACT_MP_RELOAD_SLIDE_GRENADELAUNCHER_LOOP,
    ACT_MP_RELOAD_SLIDE_GRENADELAUNCHER_END,
    ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER,        // CROUCHWALK
    ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER_LOOP,
    ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER_END,
    ACT_MP_RELOAD_SWIM_GRENADELAUNCHER,
    ACT_MP_RELOAD_SWIM_GRENADELAUNCHER_LOOP,
    ACT_MP_RELOAD_SWIM_GRENADELAUNCHER_END,
    ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER,
    ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER_LOOP,
    ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER_END,
 
    // Super Shotgun.
    ACT_MP_STAND_SUPERSHOTGUN,
    ACT_MP_CROUCH_SUPERSHOTGUN,
    ACT_MP_RUN_SUPERSHOTGUN,
	ACT_MP_SLIDE_SUPERSHOTGUN,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_SUPERSHOTGUN,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_SUPERSHOTGUN,
    ACT_MP_CROUCHWALK_SUPERSHOTGUN,
    ACT_MP_JUMP_START_SUPERSHOTGUN,
    ACT_MP_JUMP_FLOAT_SUPERSHOTGUN,
    ACT_MP_JUMP_LAND_SUPERSHOTGUN,
    ACT_MP_SWIM_SUPERSHOTGUN,
 
    ACT_MP_ATTACK_STAND_SUPERSHOTGUN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_SUPERSHOTGUN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_SUPERSHOTGUN,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_SUPERSHOTGUN,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_SUPERSHOTGUN,
    ACT_MP_ATTACK_AIRWALK_SUPERSHOTGUN,
 
    ACT_MP_DRAW_STAND_SUPERSHOTGUN,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_SUPERSHOTGUN,		//SLIDE	
    ACT_MP_DRAW_CROUCH_SUPERSHOTGUN,
 
    ACT_MP_RELOAD_STAND_SUPERSHOTGUN,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_SUPERSHOTGUN,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_SUPERSHOTGUN,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_SUPERSHOTGUN,
    ACT_MP_RELOAD_AIRWALK_SUPERSHOTGUN,
 
	// AssaultRifle.
    ACT_MP_STAND_ASSAULTRIFLE,
    ACT_MP_CROUCH_ASSAULTRIFLE,
    ACT_MP_RUN_ASSAULTRIFLE,
	ACT_MP_SLIDE_ASSAULTRIFLE,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_ASSAULTRIFLE,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_ASSAULTRIFLE,
    ACT_MP_CROUCHWALK_ASSAULTRIFLE,
    ACT_MP_JUMP_START_ASSAULTRIFLE,
    ACT_MP_JUMP_FLOAT_ASSAULTRIFLE,
    ACT_MP_JUMP_LAND_ASSAULTRIFLE,
    ACT_MP_SWIM_ASSAULTRIFLE,
 
    ACT_MP_ATTACK_STAND_ASSAULTRIFLE,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_ASSAULTRIFLE,			//SLIDE
	ACT_MP_ATTACK_TACKLE_ASSAULTRIFLE,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_ASSAULTRIFLE,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_ASSAULTRIFLE,
    ACT_MP_ATTACK_AIRWALK_ASSAULTRIFLE,
 
    ACT_MP_DRAW_STAND_ASSAULTRIFLE,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_ASSAULTRIFLE,		//SLIDE	
    ACT_MP_DRAW_CROUCH_ASSAULTRIFLE,
 
    ACT_MP_RELOAD_STAND_ASSAULTRIFLE,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_ASSAULTRIFLE,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_ASSAULTRIFLE,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_ASSAULTRIFLE,
    ACT_MP_RELOAD_AIRWALK_ASSAULTRIFLE,
 
	// LeverRifle.
	ACT_MP_STAND_LEVERRIFLE,
	ACT_MP_CROUCH_LEVERRIFLE,
	ACT_MP_RUN_LEVERRIFLE,
	ACT_MP_SLIDE_LEVERRIFLE,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_LEVERRIFLE,			//HEAVY GRUNT SHOULDER-TACKLE	
	ACT_MP_AIRWALK_LEVERRIFLE,
	ACT_MP_CROUCHWALK_LEVERRIFLE,
	ACT_MP_JUMP_START_LEVERRIFLE,
	ACT_MP_JUMP_FLOAT_LEVERRIFLE,
	ACT_MP_JUMP_LAND_LEVERRIFLE,
	ACT_MP_SWIM_LEVERRIFLE,

	ACT_MP_CROUCH_DEPLOYED_IDLE_LEVERRIFLE,
	ACT_MP_CROUCHWALK_DEPLOYED_LEVERRIFLE,
	ACT_MP_DEPLOYED_IDLE_LEVERRIFLE,
	ACT_MP_SWIM_DEPLOYED_LEVERRIFLE,

    ACT_MP_ATTACK_STAND_LEVERRIFLE,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_LEVERRIFLE,			//SLIDE
	ACT_MP_ATTACK_TACKLE_LEVERRIFLE,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_LEVERRIFLE,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_LEVERRIFLE,
    ACT_MP_ATTACK_AIRWALK_LEVERRIFLE,

	ACT_MP_SECONDARYATTACK_STAND_LEVERRIFLE,        // RUN, WALK
	ACT_MP_SECONDARYATTACK_SLIDE_LEVERRIFLE,			//SLIDE
	ACT_MP_SECONDARYATTACK_CROUCH_LEVERRIFLE,        // CROUCHWALK
	ACT_MP_SECONDARYATTACK_SWIM_LEVERRIFLE,
	ACT_MP_SECONDARYATTACK_AIRWALK_LEVERRIFLE,

	ACT_MP_DRAW_STAND_LEVERRIFLE,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_LEVERRIFLE,		//SLIDE		
	ACT_MP_DRAW_CROUCH_LEVERRIFLE,
 
	// SuperNailgun.
    ACT_MP_STAND_SUPERNAILGUN,
    ACT_MP_CROUCH_SUPERNAILGUN,
    ACT_MP_RUN_SUPERNAILGUN,
	ACT_MP_SLIDE_SUPERNAILGUN,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_SUPERNAILGUN,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_SUPERNAILGUN,
    ACT_MP_CROUCHWALK_SUPERNAILGUN,
    ACT_MP_JUMP_START_SUPERNAILGUN,
    ACT_MP_JUMP_FLOAT_SUPERNAILGUN,
    ACT_MP_JUMP_LAND_SUPERNAILGUN,
    ACT_MP_SWIM_SUPERNAILGUN,
 
    ACT_MP_ATTACK_STAND_SUPERNAILGUN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_SUPERNAILGUN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_SUPERNAILGUN,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_SUPERNAILGUN,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_SUPERNAILGUN,
    ACT_MP_ATTACK_AIRWALK_SUPERNAILGUN,
 
    ACT_MP_DRAW_STAND_SUPERNAILGUN,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_SUPERNAILGUN,		//SLIDE	
    ACT_MP_DRAW_CROUCH_SUPERNAILGUN,
 
    ACT_MP_RELOAD_STAND_SUPERNAILGUN,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_SUPERNAILGUN,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_SUPERNAILGUN,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_SUPERNAILGUN,
    ACT_MP_RELOAD_AIRWALK_SUPERNAILGUN,
 
	// Flamethrower.
    ACT_MP_STAND_FLAMETHROWER,
    ACT_MP_CROUCH_FLAMETHROWER,
    ACT_MP_RUN_FLAMETHROWER,
	ACT_MP_SLIDE_FLAMETHROWER,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_FLAMETHROWER,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_FLAMETHROWER,
    ACT_MP_CROUCHWALK_FLAMETHROWER,
    ACT_MP_JUMP_START_FLAMETHROWER,
    ACT_MP_JUMP_FLOAT_FLAMETHROWER,
    ACT_MP_JUMP_LAND_FLAMETHROWER,
    ACT_MP_SWIM_FLAMETHROWER,

    ACT_MP_ATTACK_STAND_FLAMETHROWER,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_FLAMETHROWER,			//SLIDE
	ACT_MP_ATTACK_TACKLE_FLAMETHROWER,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_FLAMETHROWER,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_FLAMETHROWER,
    ACT_MP_ATTACK_AIRWALK_FLAMETHROWER,

	ACT_MP_ATTACK_STAND_PREFIRE_FLAMETHROWER,
	ACT_MP_ATTACK_STAND_POSTFIRE_FLAMETHROWER,
	ACT_MP_ATTACK_SLIDE_PREFIRE_FLAMETHROWER,			//SLIDE
	ACT_MP_ATTACK_SLIDE_POSTFIRE_FLAMETHROWER,
	ACT_MP_ATTACK_CROUCH_PREFIRE_FLAMETHROWER,
	ACT_MP_ATTACK_CROUCH_POSTFIRE_FLAMETHROWER,
	ACT_MP_ATTACK_SWIM_PREFIRE_FLAMETHROWER,
	ACT_MP_ATTACK_SWIM_POSTFIRE_FLAMETHROWER,

    ACT_MP_DRAW_STAND_FLAMETHROWER,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_FLAMETHROWER,		//SLIDE	
    ACT_MP_DRAW_CROUCH_FLAMETHROWER,
 
	// Chainsaw.
    ACT_MP_STAND_CHAINSAW,
    ACT_MP_CROUCH_CHAINSAW,
    ACT_MP_RUN_CHAINSAW,
	ACT_MP_SLIDE_CHAINSAW,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_CHAINSAW,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_CHAINSAW,
    ACT_MP_CROUCHWALK_CHAINSAW,
    ACT_MP_JUMP_START_CHAINSAW,
    ACT_MP_JUMP_FLOAT_CHAINSAW,
    ACT_MP_JUMP_LAND_CHAINSAW,
    ACT_MP_SWIM_CHAINSAW,

    ACT_MP_ATTACK_STAND_CHAINSAW,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_CHAINSAW,			//SLIDE
	ACT_MP_ATTACK_TACKLE_CHAINSAW,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_CHAINSAW,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_CHAINSAW,
    ACT_MP_ATTACK_AIRWALK_CHAINSAW,

	ACT_MP_ATTACK_STAND_PREFIRE_CHAINSAW,
	ACT_MP_ATTACK_STAND_POSTFIRE_CHAINSAW,
	ACT_MP_ATTACK_SLIDE_PREFIRE_CHAINSAW,	//SLIDE
	ACT_MP_ATTACK_SLIDE_POSTFIRE_CHAINSAW,
	ACT_MP_ATTACK_CROUCH_PREFIRE_CHAINSAW,
	ACT_MP_ATTACK_CROUCH_POSTFIRE_CHAINSAW,
	ACT_MP_ATTACK_SWIM_PREFIRE_CHAINSAW,
	ACT_MP_ATTACK_SWIM_POSTFIRE_CHAINSAW,

    ACT_MP_DRAW_STAND_CHAINSAW,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_CHAINSAW,		//SLIDE	
    ACT_MP_DRAW_CROUCH_CHAINSAW,
 
	// HuntingShotgun.
    ACT_MP_STAND_HUNTINGSHOTGUN,
    ACT_MP_CROUCH_HUNTINGSHOTGUN,
    ACT_MP_RUN_HUNTINGSHOTGUN,
	ACT_MP_SLIDE_HUNTINGSHOTGUN,			//LIGHT GRUNT SLIDE
	ACT_MP_TACKLE_HUNTINGSHOTGUN,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_HUNTINGSHOTGUN,
    ACT_MP_CROUCHWALK_HUNTINGSHOTGUN,
    ACT_MP_JUMP_START_HUNTINGSHOTGUN,
    ACT_MP_JUMP_FLOAT_HUNTINGSHOTGUN,
    ACT_MP_JUMP_LAND_HUNTINGSHOTGUN,
    ACT_MP_SWIM_HUNTINGSHOTGUN,
 
    ACT_MP_ATTACK_STAND_HUNTINGSHOTGUN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_HUNTINGSHOTGUN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_HUNTINGSHOTGUN,			//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_HUNTINGSHOTGUN,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_HUNTINGSHOTGUN,
    ACT_MP_ATTACK_AIRWALK_HUNTINGSHOTGUN,
 
    ACT_MP_DRAW_STAND_HUNTINGSHOTGUN,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_HUNTINGSHOTGUN,		//SLIDE
    ACT_MP_DRAW_CROUCH_HUNTINGSHOTGUN,
 
    ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN,        // RUN, WALK
    ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN_LOOP,
    ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN_END,
	ACT_MP_RELOAD_SLIDE_HUNTINGSHOTGUN,        // SLIDE
    ACT_MP_RELOAD_SLIDE_HUNTINGSHOTGUN_LOOP,
    ACT_MP_RELOAD_SLIDE_HUNTINGSHOTGUN_END,
    ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN,        // CROUCHWALK
    ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN_LOOP,
    ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN_END,
    ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN,
    ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN_LOOP,
    ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN_END,
    ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN,
    ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN_LOOP,
    ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN_END,
	...
	// Shotgun.
    ACT_MP_STAND_SHOTGUN,
    ACT_MP_CROUCH_SHOTGUN,
    ACT_MP_RUN_SHOTGUN,
	ACT_MP_SLIDE_SHOTGUN,			//LIGHT GRUNT SLIDE
	ACT_MP_TACKLE_SHOTGUN,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_SHOTGUN,
    ACT_MP_CROUCHWALK_SHOTGUN,
    ACT_MP_JUMP_START_SHOTGUN,
    ACT_MP_JUMP_FLOAT_SHOTGUN,
    ACT_MP_JUMP_LAND_SHOTGUN,
    ACT_MP_SWIM_SHOTGUN,
 
    ACT_MP_ATTACK_STAND_SHOTGUN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_SHOTGUN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_SHOTGUN,			//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_SHOTGUN,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_SHOTGUN,
    ACT_MP_ATTACK_AIRWALK_SHOTGUN,
 
    ACT_MP_DRAW_STAND_SHOTGUN,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_SHOTGUN,		//SLIDE
    ACT_MP_DRAW_CROUCH_SHOTGUN,
 
    ACT_MP_RELOAD_STAND_SHOTGUN,        // RUN, WALK
    ACT_MP_RELOAD_STAND_SHOTGUN_LOOP,
    ACT_MP_RELOAD_STAND_SHOTGUN_END,
	ACT_MP_RELOAD_SLIDE_SHOTGUN,        // SLIDE
    ACT_MP_RELOAD_SLIDE_SHOTGUN_LOOP,
    ACT_MP_RELOAD_SLIDE_SHOTGUN_END,
    ACT_MP_RELOAD_CROUCH_SHOTGUN,        // CROUCHWALK
    ACT_MP_RELOAD_CROUCH_SHOTGUN_LOOP,
    ACT_MP_RELOAD_CROUCH_SHOTGUN_END,
    ACT_MP_RELOAD_SWIM_SHOTGUN,
    ACT_MP_RELOAD_SWIM_SHOTGUN_LOOP,
    ACT_MP_RELOAD_SWIM_SHOTGUN_END,
    ACT_MP_RELOAD_AIRWALK_SHOTGUN,
    ACT_MP_RELOAD_AIRWALK_SHOTGUN_LOOP,
    ACT_MP_RELOAD_AIRWALK_SHOTGUN_END,
 
	// Pistol.
    ACT_MP_STAND_PISTOL,
    ACT_MP_CROUCH_PISTOL,
    ACT_MP_RUN_PISTOL,
	ACT_MP_SLIDE_PISTOL,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_PISTOL,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_PISTOL,
    ACT_MP_CROUCHWALK_PISTOL,
    ACT_MP_JUMP_START_PISTOL,
    ACT_MP_JUMP_FLOAT_PISTOL,
    ACT_MP_JUMP_LAND_PISTOL,
    ACT_MP_SWIM_PISTOL,
 
    ACT_MP_ATTACK_STAND_PISTOL,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_PISTOL,			//SLIDE
	ACT_MP_ATTACK_TACKLE_PISTOL,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_PISTOL,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_PISTOL,
    ACT_MP_ATTACK_AIRWALK_PISTOL,
 
    ACT_MP_DRAW_STAND_PISTOL,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_PISTOL,		//SLIDE	
    ACT_MP_DRAW_CROUCH_PISTOL,
 
    ACT_MP_RELOAD_STAND_PISTOL,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_PISTOL,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_PISTOL,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_PISTOL,
    ACT_MP_RELOAD_AIRWALK_PISTOL,
 
	// Sten.
    ACT_MP_STAND_STEN,
    ACT_MP_CROUCH_STEN,
    ACT_MP_RUN_STEN,
	ACT_MP_SLIDE_STEN,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_STEN,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_STEN,
    ACT_MP_CROUCHWALK_STEN,
    ACT_MP_JUMP_START_STEN,
    ACT_MP_JUMP_FLOAT_STEN,
    ACT_MP_JUMP_LAND_STEN,
    ACT_MP_SWIM_STEN,
 
    ACT_MP_ATTACK_STAND_STEN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_STEN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_STEN,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_STEN,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_STEN,
    ACT_MP_ATTACK_AIRWALK_STEN,
 
    ACT_MP_DRAW_STAND_STEN,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_STEN,		//SLIDE	
    ACT_MP_DRAW_CROUCH_STEN,
 
    ACT_MP_RELOAD_STAND_STEN,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_STEN,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_STEN,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_STEN,
    ACT_MP_RELOAD_AIRWALK_STEN,

 
	// Revolver.
    ACT_MP_STAND_REVOLVER,
    ACT_MP_CROUCH_REVOLVER,
    ACT_MP_RUN_REVOLVER,
	ACT_MP_SLIDE_REVOLVER,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_REVOLVER,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_REVOLVER,
    ACT_MP_CROUCHWALK_REVOLVER,
    ACT_MP_JUMP_START_REVOLVER,
    ACT_MP_JUMP_FLOAT_REVOLVER,
    ACT_MP_JUMP_LAND_REVOLVER,
    ACT_MP_SWIM_REVOLVER,
 
    ACT_MP_ATTACK_STAND_REVOLVER,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_REVOLVER,			//SLIDE
	ACT_MP_ATTACK_TACKLE_REVOLVER,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_REVOLVER,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_REVOLVER,
    ACT_MP_ATTACK_AIRWALK_REVOLVER,
 
    ACT_MP_DRAW_STAND_REVOLVER,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_REVOLVER,		//SLIDE	
    ACT_MP_DRAW_CROUCH_REVOLVER,
 
    ACT_MP_RELOAD_STAND_REVOLVER,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_REVOLVER,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_REVOLVER,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_REVOLVER,
    ACT_MP_RELOAD_AIRWALK_REVOLVER,
 
 	// Nailgun.
    ACT_MP_STAND_NAILGUN,
    ACT_MP_CROUCH_NAILGUN,
    ACT_MP_RUN_NAILGUN,
	ACT_MP_SLIDE_NAILGUN,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_NAILGUN,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_NAILGUN,
    ACT_MP_CROUCHWALK_NAILGUN,
    ACT_MP_JUMP_START_NAILGUN,
    ACT_MP_JUMP_FLOAT_NAILGUN,
    ACT_MP_JUMP_LAND_NAILGUN,
    ACT_MP_SWIM_NAILGUN,
 
    ACT_MP_ATTACK_STAND_NAILGUN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_NAILGUN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_NAILGUN,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_NAILGUN,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_NAILGUN,
    ACT_MP_ATTACK_AIRWALK_NAILGUN,
 
    ACT_MP_DRAW_STAND_NAILGUN,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_NAILGUN,		//SLIDE	
    ACT_MP_DRAW_CROUCH_NAILGUN,
 
    ACT_MP_RELOAD_STAND_NAILGUN,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_NAILGUN,        // SLIDE	
    ACT_MP_RELOAD_CROUCH_NAILGUN,        // CROUCHWALK
    ACT_MP_RELOAD_SWIM_NAILGUN,
    ACT_MP_RELOAD_AIRWALK_NAILGUN,

 
	// Flaregun.
    ACT_MP_STAND_FLAREGUN,
	ACT_MP_CROUCH_FLAREGUN,
	ACT_MP_RUN_FLAREGUN,
	ACT_MP_SLIDE_FLAREGUN,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_FLAREGUN,			//HEAVY GRUNT SHOULDER-TACKLE
	ACT_MP_AIRWALK_FLAREGUN,
	ACT_MP_CROUCHWALK_FLAREGUN,
	ACT_MP_JUMP_START_FLAREGUN,
	ACT_MP_JUMP_FLOAT_FLAREGUN,
	ACT_MP_JUMP_LAND_FLAREGUN,
	ACT_MP_SWIM_FLAREGUN,

	ACT_MP_ATTACK_STAND_FLAREGUN,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_FLAREGUN,			//SLIDE
	ACT_MP_ATTACK_TACKLE_FLAREGUN,		//SHOULDER-TACKLE
	ACT_MP_ATTACK_CROUCH_FLAREGUN,        // CROUCHWALK
	ACT_MP_ATTACK_SWIM_FLAREGUN,
	ACT_MP_ATTACK_AIRWALK_FLAREGUN,

	ACT_MP_DRAW_STAND_FLAREGUN,
	ACT_MP_DRAW_SLIDE_FLAREGUN,
	ACT_MP_DRAW_CROUCH_FLAREGUN,

	ACT_MP_RELOAD_STAND_FLAREGUN,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_FLAREGUNR,        // SLIDE
	ACT_MP_RELOAD_CROUCH_FLAREGUN,        // CROUCHWALK
	ACT_MP_RELOAD_SWIM_FLAREGUN,
	ACT_MP_RELOAD_AIRWALK_FLAREGUN,
 
	// Remotebomb.
	ACT_MP_STAND_REMOTEBOMB,
	ACT_MP_CROUCH_REMOTEBOMB,
	ACT_MP_RUN_REMOTEBOMB,
	ACT_MP_SLIDE_REMOTEBOMB,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_REMOTEBOMB,			//HEAVY GRUNT SHOULDER-TACKLE	
	ACT_MP_AIRWALK_REMOTEBOMB,
	ACT_MP_CROUCHWALK_REMOTEBOMB,
	ACT_MP_JUMP_START_REMOTEBOMB,
	ACT_MP_JUMP_FLOAT_REMOTEBOMB,
	ACT_MP_JUMP_LAND_REMOTEBOMB,
	ACT_MP_SWIM_REMOTEBOMB,

	ACT_MP_ATTACK_STAND_REMOTEBOMB,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_REMOTEBOMB,			//SLIDE
	ACT_MP_ATTACK_TACKLE_REMOTEBOMB,		//SHOULDER-TACKLE
	ACT_MP_ATTACK_CROUCH_REMOTEBOMB,        // CROUCHWALK
	ACT_MP_ATTACK_SWIM_REMOTEBOMB,
	ACT_MP_ATTACK_AIRWALK_REMOTEBOMB,

	ACT_MP_DRAW_STAND_REMOTEBOMB,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_REMOTEBOMB,        // SLIDE	
	ACT_MP_DRAW_CROUCH_REMOTEBOMB,

	ACT_MP_STAND_REMOTEBOMB_ALT,
	ACT_MP_CROUCH_REMOTEBOMB_ALT,
	ACT_MP_RUN_REMOTEBOMB_ALT,
	ACT_MP_SLIDE_REMOTEBOMB_ALT,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_REMOTEBOMB_ALT,			//HEAVY GRUNT SHOULDER-TACKLE	
	ACT_MP_AIRWALK_REMOTEBOMB_ALT,
	ACT_MP_CROUCHWALK_REMOTEBOMB_ALT,
	ACT_MP_JUMP_START_REMOTEBOMB_ALT,
	ACT_MP_JUMP_FLOAT_REMOTEBOMB_ALT,
	ACT_MP_JUMP_LAND_REMOTEBOMB_ALT,
	ACT_MP_SWIM_REMOTEBOMB_ALT,

	ACT_MP_DRAW_STAND_REMOTEBOMB_ALT,
	ACT_MP_DRAW_CROUCH_REMOTEBOMB_ALT,
	ACT_MP_ATTACK_STAND_REMOTEBOMB_ALT,        // RUN, WALK
	ACT_MP_RELOAD_SLIDE_REMOTEBOMB_ALT,        // SLIDE
	ACT_MP_ATTACK_TACKLE_REMOTEBOMB_ALT,		//SHOULDER-TACKLE
	ACT_MP_ATTACK_CROUCH_REMOTEBOMB_ALT,        // CROUCHWALK
	ACT_MP_ATTACK_SWIM_REMOTEBOMB_ALT,
	ACT_MP_ATTACK_AIRWALK_REMOTEBOMB_ALT,
    ...
    // Displacer.
    ACT_MP_STAND_DISPLACER,
    ACT_MP_CROUCH_DISPLACER,
    ACT_MP_RUN_DISPLACER,
	ACT_MP_SLIDE_DISPLACER,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_DISPLACER,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_DISPLACER,
    ACT_MP_CROUCHWALK_DISPLACER,
    ACT_MP_JUMP_START_DISPLACER,
    ACT_MP_JUMP_FLOAT_DISPLACER,
    ACT_MP_JUMP_LAND_DISPLACER,
    ACT_MP_SWIM_DISPLACER,
	ACT_MP_ATTACK_STAND_DISPLACER,
	ACT_MP_ATTACK_SLIDE_DISPLACER,
	ACT_MP_ATTACK_TACKLE_DISPLACER,
	ACT_MP_ATTACK_CROUCH_DISPLACER,
	ACT_MP_ATTACK_SWIM_DISPLACER,
	ACT_MP_ATTACK_AIRWALK_DISPLACER,

 
    ACT_MP_DRAW_STAND_DISPLACER,        // RUN, WALK
    ACT_MP_DRAW_SLIDE_DISPLACER,        // SLIDE
    ACT_MP_DRAW_CROUCH_DISPLACER,
    ...
    ACT_MP_STAND_TIREIRON,
    ACT_MP_CROUCH_TIREIRON,
    ACT_MP_RUN_TIREIRON,
	ACT_MP_SLIDE_TIREIRON,		//LIGHT GRUNT SLIDE
    ACT_MP_AIRWALK_TIREIRON,
    ACT_MP_CROUCHWALK_TIREIRON,
    ACT_MP_JUMP_START_TIREIRON,
    ACT_MP_JUMP_FLOAT_TIREIRON,
    ACT_MP_JUMP_LAND_TIREIRON,
    ACT_MP_SWIM_TIREIRON,
 
    ACT_MP_ATTACK_STAND_TIREIRON,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_TIREIRON,		// SLIDE
    ACT_MP_ATTACK_CROUCH_TIREIRON,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_TIREIRON,
    ACT_MP_ATTACK_AIRWALK_TIREIRON,
 
    ACT_MP_DRAW_STAND_TIREIRON,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_TIREIRON,
    ACT_MP_DRAW_CROUCH_TIREIRON,
 
    // Crowbar. MEDIUM GRUNT MELEE
    ACT_MP_STAND_CROWBAR,
    ACT_MP_CROUCH_CROWBAR,
    ACT_MP_RUN_CROWBAR,
    ACT_MP_AIRWALK_CROWBAR,
    ACT_MP_CROUCHWALK_CROWBAR,
    ACT_MP_JUMP_START_CROWBAR,
    ACT_MP_JUMP_FLOAT_CROWBAR,
    ACT_MP_JUMP_LAND_CROWBAR,
    ACT_MP_SWIM_CROWBAR,
 
    ACT_MP_ATTACK_STAND_CROWBAR,        // RUN, WALK
    ACT_MP_ATTACK_CROUCH_CROWBAR,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_CROWBAR,
    ACT_MP_ATTACK_AIRWALK_CROWBAR,
 
    ACT_MP_DRAW_STAND_CROWBAR,        // RUN, WALK
    ACT_MP_DRAW_CROUCH_CROWBAR,
	
    // LeadPipe. HEAVY GRUNT MELEE
    ACT_MP_STAND_LEADPIPE,
    ACT_MP_CROUCH_LEADPIPE,
    ACT_MP_RUN_LEADPIPE,
	ACT_MP_TACKLE_LEADPIPE,	//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_LEADPIPE,
    ACT_MP_CROUCHWALK_LEADPIPE,
    ACT_MP_JUMP_START_LEADPIPE,
    ACT_MP_JUMP_FLOAT_LEADPIPE,
    ACT_MP_JUMP_LAND_LEADPIPE,
    ACT_MP_SWIM_LEADPIPE,
 
    ACT_MP_ATTACK_STAND_LEADPIPE,        // RUN, WALK
    ACT_MP_ATTACK_CROUCH_LEADPIPE,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_LEADPIPE,
    ACT_MP_ATTACK_AIRWALK_LEADPIPE,
 
    ACT_MP_DRAW_STAND_LEADPIPE,        // RUN, WALK
    ACT_MP_DRAW_CROUCH_LEADPIPE,

	// Umbrella. VIP MELEE
	ACT_MP_STAND_UMBRELLA,
	ACT_MP_CROUCH_UMBRELLA,
	ACT_MP_RUN_UMBRELLA,
	ACT_MP_AIRWALK_UMBRELLA,
	ACT_MP_CROUCHWALK_UMBRELLA,
	ACT_MP_JUMP_START_UMBRELLA,
	ACT_MP_JUMP_FLOAT_UMBRELLA,
	ACT_MP_JUMP_LAND_UMBRELLA,
	ACT_MP_SWIM_UMBRELLA,

	ACT_MP_ATTACK_STAND_UMBRELLA,        // RUN, WALK
	ACT_MP_ATTACK_CROUCH_UMBRELLA,        // CROUCHWALK
	ACT_MP_ATTACK_SWIM_UMBRELLA,
	ACT_MP_ATTACK_AIRWALK_UMBRELLA,

	ACT_MP_DRAW_STAND_UMBRELLA,        // RUN, WALK
	ACT_MP_DRAW_CROUCH_UMBRELLA,
    ...
    ACT_MP_CROUCH_FLAG,
    ACT_MP_RUN_FLAG,
	ACT_MP_SLIDE_FLAG,			//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_FLAG,			//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_FLAG,
    ACT_MP_CROUCHWALK_FLAG,
    ACT_MP_JUMP_START_FLAG,
    ACT_MP_JUMP_FLOAT_FLAG,
    ACT_MP_JUMP_LAND_FLAG,
    ACT_MP_SWIM_FLAG,
 
    ACT_MP_ATTACK_STAND_FLAG,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_FLAG,			//SLIDE
	ACT_MP_ATTACK_TACKLE_FLAG,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_FLAG,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_FLAG,
    ACT_MP_ATTACK_AIRWALK_FLAG,
 
    ACT_MP_DRAW_STAND_FLAG,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_FLAG,		//SLIDE	
    ACT_MP_DRAW_CROUCH_FLAG,
 
    // Hammerfists.
    ACT_MP_STAND_HAMMERFISTS,
    ACT_MP_CROUCH_HAMMERFISTS,
    ACT_MP_RUN_HAMMERFISTS,
	ACT_MP_SLIDE_HAMMERFISTS,		//LIGHT GRUNT SLIDE 
	ACT_MP_TACKLE_HAMMERFISTS,		//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_HAMMERFISTS,	
    ACT_MP_CROUCHWALK_HAMMERFISTS,
    ACT_MP_JUMP_START_HAMMERFISTS,
    ACT_MP_JUMP_FLOAT_HAMMERFISTS,
    ACT_MP_JUMP_LAND_HAMMERFISTS,
    ACT_MP_SWIM_HAMMERFISTS,
 
    ACT_MP_ATTACK_STAND_HAMMERFISTS,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_HAMMERFISTS,			//SLIDE
	ACT_MP_ATTACK_TACKLE_HAMMERFISTS,		//SHOULDER-TACKLE
    ACT_MP_ATTACK_CROUCH_HAMMERFISTS,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_HAMMERFISTS,
    ACT_MP_ATTACK_AIRWALK_HAMMERFISTS,
 
    ACT_MP_DRAW_STAND_HAMMERFISTS,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_HAMMERFISTS,		//SLIDE	
    ACT_MP_DRAW_CROUCH_HAMMERFISTS,
 
    // Claws.
    ACT_MP_STAND_CLAWS,
    ACT_MP_CROUCH_CLAWS,
    ACT_MP_RUN_CLAWS,
	ACT_MP_SLIDE_CLAWS,		//LIGHT GRUNT SLIDE
	ACT_MP_TACKLE_CLAWS,		//HEAVY GRUNT SHOULDER-TACKLE
    ACT_MP_AIRWALK_CLAWS,
    ACT_MP_CROUCHWALK_CLAWS,
    ACT_MP_JUMP_START_CLAWS,
    ACT_MP_JUMP_FLOAT_CLAWS,
    ACT_MP_JUMP_LAND_CLAWS,
    ACT_MP_SWIM_CLAWS,
 
    ACT_MP_ATTACK_STAND_CLAWS,        // RUN, WALK
	ACT_MP_ATTACK_SLIDE_CLAWS,			// SLIDE
    ACT_MP_ATTACK_CROUCH_CLAWS,        // CROUCHWALK
    ACT_MP_ATTACK_SWIM_CLAWS,
    ACT_MP_ATTACK_AIRWALK_CLAWS,
 
    ACT_MP_DRAW_STAND_CLAWS,        // RUN, WALK
	ACT_MP_DRAW_SLIDE_CLAWS,		// SLIDE
    ACT_MP_DRAW_CROUCH_CLAWS,
