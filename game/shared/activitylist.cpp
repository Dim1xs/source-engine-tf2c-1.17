...
//HL2MP
    ...
    // Rocketlauncher.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_ROCKETLAUNCHER );			//LIGHT GRUNT SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_ROCKETLAUNCHER );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_ROCKETLAUNCHER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_ROCKETLAUNCHER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_ROCKETLAUNCHER );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_ROCKETLAUNCHER );			//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_ROCKETLAUNCHER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_ROCKETLAUNCHER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_ROCKETLAUNCHER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_ROCKETLAUNCHER );		//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_ROCKETLAUNCHER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ROCKETLAUNCHER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ROCKETLAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ROCKETLAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_ROCKETLAUNCHER );        // SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_ROCKETLAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_ROCKETLAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ROCKETLAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ROCKETLAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ROCKETLAUNCHER_END );
 
	// GRENADELAUNCHER.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_GRENADELAUNCHER );			//LIGHT GRUNT SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_GRENADELAUNCHER );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_GRENADELAUNCHER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_GRENADELAUNCHER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_GRENADELAUNCHER );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_GRENADELAUNCHER );			//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_GRENADELAUNCHER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_GRENADELAUNCHER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_GRENADELAUNCHER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_GRENADELAUNCHER );		//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_GRENADELAUNCHER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_GRENADELAUNCHER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_GRENADELAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_GRENADELAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_GRENADELAUNCHER );        // SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_GRENADELAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_GRENADELAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_GRENADELAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_GRENADELAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_GRENADELAUNCHER_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_GRENADELAUNCHER_END );
 
	// Super Shotgun.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_SUPERSHOTGUN );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_SUPERSHOTGUN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_SUPERSHOTGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_SUPERSHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_SUPERSHOTGUN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_SUPERSHOTGUN );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_SUPERSHOTGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_SUPERSHOTGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_SUPERSHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_SUPERSHOTGUN );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_SUPERSHOTGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_SUPERSHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_SUPERSHOTGUN );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_SUPERSHOTGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_SUPERSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_SUPERSHOTGUN );
 
	// AssaultRifle.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_ASSAULTRIFLE );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_ASSAULTRIFLE );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_ASSAULTRIFLE );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_ASSAULTRIFLE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_ASSAULTRIFLE );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_ASSAULTRIFLE );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_ASSAULTRIFLE );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_ASSAULTRIFLE );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_ASSAULTRIFLE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_ASSAULTRIFLE );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_ASSAULTRIFLE );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_ASSAULTRIFLE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_ASSAULTRIFLE );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_ASSAULTRIFLE );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_ASSAULTRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_ASSAULTRIFLE );
 
	// LeverRifle.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_LEVERRIFLE );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_LEVERRIFLE );			//HEAVY GRUNT SHOULDER-TACKLE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_LEVERRIFLE );

	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_DEPLOYED_IDLE_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_DEPLOYED_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_DEPLOYED_IDLE_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_DEPLOYED_LEVERRIFLE );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_LEVERRIFLE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_LEVERRIFLE );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_LEVERRIFLE );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_LEVERRIFLE );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_LEVERRIFLE );

	REGISTER_SHARED_ACTIVITY( ACT_MP_SECONDARYATTACK_STAND_LEVERRIFLE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_SECONDARYATTACK_SLIDE_LEVERRIFLE );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_SECONDARYATTACK_CROUCH_LEVERRIFLE );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_SECONDARYATTACK_SWIM_LEVERRIFLE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SECONDARYATTACK_AIRWALK_LEVERRIFLE );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_LEVERRIFLE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_LEVERRIFLE );		//SLIDE		
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_LEVERRIFLE );
 
	// SuperNailgun.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_SUPERNAILGUN );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_SUPERNAILGUN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_SUPERNAILGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_SUPERNAILGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_SUPERNAILGUN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_SUPERNAILGUN );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_SUPERNAILGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_SUPERNAILGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_SUPERNAILGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_SUPERNAILGUN );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_SUPERNAILGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_SUPERNAILGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_SUPERNAILGUN );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_SUPERNAILGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_SUPERNAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_SUPERNAILGUN );
 
	// Flamethrower.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_FLAMETHROWER );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_FLAMETHROWER );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_FLAMETHROWER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_FLAMETHROWER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_FLAMETHROWER );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_FLAMETHROWER );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_FLAMETHROWER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_FLAMETHROWER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_PREFIRE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_POSTFIRE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_PREFIRE_FLAMETHROWER );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_POSTFIRE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_PREFIRE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_POSTFIRE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_PREFIRE_FLAMETHROWER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_POSTFIRE_FLAMETHROWER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_FLAMETHROWER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_FLAMETHROWER );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_FLAMETHROWER );

	// Chainsaw.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_CHAINSAW );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_CHAINSAW );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_CHAINSAW );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_CHAINSAW );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_CHAINSAW );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_CHAINSAW );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_CHAINSAW );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_CHAINSAW );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_PREFIRE_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_POSTFIRE_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_PREFIRE_CHAINSAW );	//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_POSTFIRE_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_PREFIRE_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_POSTFIRE_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_PREFIRE_CHAINSAW );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_POSTFIRE_CHAINSAW );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_CHAINSAW );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_CHAINSAW );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_CHAINSAW );
 
	// HuntingShotgun.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_HUNTINGSHOTGUN );			//LIGHT GRUNT SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_HUNTINGSHOTGUN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_HUNTINGSHOTGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_HUNTINGSHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_HUNTINGSHOTGUN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_HUNTINGSHOTGUN );			//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_HUNTINGSHOTGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_HUNTINGSHOTGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_HUNTINGSHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_HUNTINGSHOTGUN );		//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_HUNTINGSHOTGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_HUNTINGSHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_HUNTINGSHOTGUN );        // SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_HUNTINGSHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_HUNTINGSHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_HUNTINGSHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_HUNTINGSHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_HUNTINGSHOTGUN_END );
	...
	// Shotgun.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_SHOTGUN );			//LIGHT GRUNT SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_SHOTGUN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_SHOTGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_SHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_SHOTGUN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_SHOTGUN );			//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_SHOTGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_SHOTGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_SHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_SHOTGUN );		//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_SHOTGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_SHOTGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_SHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_SHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_SHOTGUN );        // SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_SHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_SHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_SHOTGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_SHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_SHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_SHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_SHOTGUN_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_SHOTGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_SHOTGUN_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_SHOTGUN_END );
 
	// Pistol.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_PISTOL );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_PISTOL );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_PISTOL );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_PISTOL );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_PISTOL );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_PISTOL );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_PISTOL );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_PISTOL );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_PISTOL );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_PISTOL );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_PISTOL );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_PISTOL );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_PISTOL );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_PISTOL );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_PISTOL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_PISTOL );

	// Sten.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_STEN );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_STEN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_STEN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_STEN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_STEN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_STEN );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_STEN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_STEN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_STEN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_STEN );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_STEN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_STEN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_STEN );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_STEN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_STEN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_STEN );

	// Revolver.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_REVOLVER );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_REVOLVER );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_REVOLVER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_REVOLVER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_REVOLVER );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_REVOLVER );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_REVOLVER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_REVOLVER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_REVOLVER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_REVOLVER );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_REVOLVER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_REVOLVER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_REVOLVER );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_REVOLVER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_REVOLVER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_REVOLVER );

	// Nailgun.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_NAILGUN );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_NAILGUN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_NAILGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_NAILGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_NAILGUN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_NAILGUN );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_NAILGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_NAILGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_NAILGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_NAILGUN );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_NAILGUN );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_NAILGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_NAILGUN );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_NAILGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_NAILGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_NAILGUN );

	// Flaregun.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_FLAREGUN );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_FLAREGUN );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_FLAREGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_FLAREGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_FLAREGUN );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_FLAREGUN );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_FLAREGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_FLAREGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_FLAREGUN );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_FLAREGUN );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_FLAREGUN );

	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_STAND_FLAREGUN );        // RUN ); WALK
//	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_FLAREGUN );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_CROUCH_FLAREGUN );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SWIM_FLAREGUN );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_AIRWALK_FLAREGUN );

	// Remotebomb.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_REMOTEBOMB );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_REMOTEBOMB );			//HEAVY GRUNT SHOULDER-TACKLE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_REMOTEBOMB );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_REMOTEBOMB );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_REMOTEBOMB );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_REMOTEBOMB );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_REMOTEBOMB );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_REMOTEBOMB );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_REMOTEBOMB );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_REMOTEBOMB );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_REMOTEBOMB );        // SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_REMOTEBOMB );

	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_REMOTEBOMB_ALT );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_REMOTEBOMB_ALT );			//HEAVY GRUNT SHOULDER-TACKLE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_REMOTEBOMB_ALT );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_REMOTEBOMB_ALT );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_REMOTEBOMB_ALT );        // SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_REMOTEBOMB_ALT );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_REMOTEBOMB_ALT );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_REMOTEBOMB_ALT );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_REMOTEBOMB_ALT );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_REMOTEBOMB_ALT );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_REMOTEBOMB_ALT );
	...
	// Displacer.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_DISPLACER );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_DISPLACER );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_DISPLACER );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_DISPLACER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_DISPLACER );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_DISPLACER );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_DISPLACER );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_DISPLACER );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_DISPLACER );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_DISPLACER );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_DISPLACER );        // SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_DISPLACER );
	...
	// Tire Iron. LIGHT GRUNT MELEE
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_TIREIRON );		//LIGHT GRUNT SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_TIREIRON );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_TIREIRON );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_TIREIRON );		// SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_TIREIRON );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_TIREIRON );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_TIREIRON );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_TIREIRON );
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_TIREIRON );
 
	// Crowbar. MEDIUM GRUNT MELEE
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_CROWBAR );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_CROWBAR );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_CROWBAR );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_CROWBAR );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_CROWBAR );

	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_CROWBAR );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_CROWBAR );

	// LeadPipe. HEAVY GRUNT MELEE
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_LEADPIPE );	//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_LEADPIPE );
	 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_LEADPIPE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_LEADPIPE );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_LEADPIPE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_LEADPIPE );
	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_LEADPIPE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_LEADPIPE );

	// Umbrella. VIP MELEE
	REGISTER_SHARED_ACTIVITY(ACT_MP_STAND_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_CROUCH_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RUN_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_AIRWALK_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_CROUCHWALK_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_START_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_FLOAT_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_JUMP_LAND_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_SWIM_UMBRELLA);

	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_UMBRELLA);        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_UMBRELLA);        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_SWIM_UMBRELLA);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_AIRWALK_UMBRELLA);

	REGISTER_SHARED_ACTIVITY(ACT_MP_DRAW_STAND_UMBRELLA);        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_DRAW_CROUCH_UMBRELLA);
	...
	// Flag.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_FLAG );			//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_FLAG );			//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_FLAG );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_FLAG );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_FLAG );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_FLAG );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_FLAG );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_FLAG );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_FLAG );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_FLAG );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_FLAG );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_FLAG );

	// Hammerfists.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_HAMMERFISTS );		//LIGHT GRUNT SLIDE 
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_HAMMERFISTS );		//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_HAMMERFISTS );	
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_HAMMERFISTS );

	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_HAMMERFISTS );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_HAMMERFISTS );			//SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_TACKLE_HAMMERFISTS );		//SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_HAMMERFISTS );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_HAMMERFISTS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_HAMMERFISTS );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_HAMMERFISTS );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_HAMMERFISTS );		//SLIDE	
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_HAMMERFISTS );

	// Claws.
	REGISTER_SHARED_ACTIVITY( ACT_MP_STAND_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCH_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RUN_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE_CLAWS );		//LIGHT GRUNT SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_TACKLE_CLAWS );		//HEAVY GRUNT SHOULDER-TACKLE
	REGISTER_SHARED_ACTIVITY( ACT_MP_AIRWALK_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_CROUCHWALK_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_START_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_FLOAT_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_JUMP_LAND_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_SWIM_CLAWS );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_STAND_CLAWS );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_CLAWS );			// SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_CROUCH_CLAWS );        // CROUCHWALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SWIM_CLAWS );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_AIRWALK_CLAWS );
 
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_STAND_CLAWS );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_SLIDE_CLAWS );		// SLIDE
	REGISTER_SHARED_ACTIVITY( ACT_MP_DRAW_CROUCH_CLAWS );

	//Sliding
	REGISTER_SHARED_ACTIVITY( ACT_MP_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_PRIMARYFIRE );        // RUN ); WALK
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE );		// SLIDE
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_LAST );
