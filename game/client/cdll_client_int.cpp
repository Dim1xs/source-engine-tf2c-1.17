...
{
	Msg("Discord: Connected to user %s#%s - %s\n",
...
#define DRPC_APPID "1051162396405805116"

#if defined( DRPC_APPID )
	Discord_Initialize( DRPC_APPID, &handlers, 1, appid );
#else
	#error "define DRPC_APPID with your discord appid"
#endif
	...
	if (!g_bTextMode)
	{
		...
		discordPresence.largeImageKey = "tdc-game";
