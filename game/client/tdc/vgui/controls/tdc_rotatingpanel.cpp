...
//-----------------------------------------------------------------------------
DECLARE_BUILD_FACTORY( CTDCRotatingImagePanel );

//-----------------------------------------------------------------------------
// Purpose: 
//-----------------------------------------------------------------------------
CTDCRotatingImagePanel::CTDCRotatingImagePanel( Panel *parent, const char *name ) : EditablePanel( parent, name )
{
	m_flAngle = 0.0f;
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCRotatingImagePanel::ApplySettings( KeyValues *inResourceData )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
float CTDCRotatingImagePanel::GetAngleRotation( void )
{
	int _x, _y;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCRotatingImagePanel::Paint()
{
