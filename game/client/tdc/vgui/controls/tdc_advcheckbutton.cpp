...
DECLARE_BUILD_FACTORY_DEFAULT_TEXT( CTDCCheckButton, CTDCCheckButton );

//-----------------------------------------------------------------------------
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTDCCheckButton::CTDCCheckButton( Panel *parent, const char *panelName, const char *text ) : CTDCButtonBase( parent, panelName, text )
{
...
CTDCCheckButton::~CTDCCheckButton()
{
	m_pCheckImage->DeletePanel();
	m_pBGBorder->DeletePanel();
}

void CTDCCheckButton::ApplySettings( KeyValues *inResourceData )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCheckButton::ApplySchemeSettings( IScheme *pScheme )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCheckButton::PerformLayout()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCheckButton::DoClick( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCheckButton::OnCheckButtonChecked( Panel *panel )
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCheckButton::SetChecked( bool bState )
{
	m_bChecked = bState;
