...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTDCButtonBase::CTDCButtonBase( Panel *parent, const char *panelName, const char *text ) : Button( parent, panelName, text )
{
...
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetArmedBorder( IBorder *border )
{
	_armedBorder = border;
...
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetSelectedBorder( IBorder *border )
{
...
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetDisabledBorder( IBorder *border )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::ApplySchemeSettings( IScheme *pScheme )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::ApplySettings( KeyValues *inResourceData )
{
...
//-----------------------------------------------------------------------------
IBorder *CTDCButtonBase::GetBorder( bool depressed, bool armed, bool selected, bool keyfocus )
{
	if ( !m_bBorderVisible )
		return NULL;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::OnCursorEntered()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::OnCursorExited()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::OnMousePressed( MouseCode code )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::OnMouseReleased( MouseCode code )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetMouseEnteredState( MouseState flag )
{
	m_iMouseState = flag;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetArmed( bool bState )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetSelected( bool bState )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCButtonBase::RequestInfo( KeyValues *data )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCButtonBase::SetInfo( KeyValues *inputData )
{
...
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetBordersByName( const char *pszBorderDefault, const char *pszBorderArmed, const char *pszBorderDepressed )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetFontByString( const char *sFont )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetImage( const char *pszImage )
{
	if ( m_pButtonImage )
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetImageInset( int iInsetX, int iInsetY )
{
	if ( m_pButtonImage )
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetImageSize( int iWide, int iTall )
{
	if ( m_pButtonImage )
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::ShowToolTip( bool bShow )
{
	if ( m_szToolTip[0] != '\0' )
	{
		if ( bShow )
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCButtonBase::SetToolTip( const char *pszText )
{
