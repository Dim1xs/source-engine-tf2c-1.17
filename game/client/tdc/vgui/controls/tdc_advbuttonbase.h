...
class CTDCButtonBase;
class CTDCToolTipPanel;
class CTDCDialogPanelBase;
...
// Purpose: 
//-----------------------------------------------------------------------------
class CTDCButtonBase : public vgui::Button
{
public:
	DECLARE_CLASS_SIMPLE( CTDCButtonBase, vgui::Button );

	CTDCButtonBase( vgui::Panel *parent, const char *panelName, const char *text );
	virtual ~CTDCButtonBase();
