...
//=============================================================================//
#include "cbase.h"
#include "tdc_createserverdialog.h"
#include <vgui_controls/ComboBox.h>
#include "controls/tdc_advpanellistpanel.h"
#include "controls/tdc_advcheckbutton.h"
...
CTDCCreateServerDialog::CTDCCreateServerDialog( Panel *pParent, const char *pszName ) : CTDCDialogPanelBase( pParent, pszName )
{
...
CTDCCreateServerDialog::~CTDCCreateServerDialog()
{
	if ( m_pSavedData )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::ApplySchemeSettings( IScheme *pScheme )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::Show( void )
{
	BaseClass::Show();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::Hide( void )
{
	OnDestroyControls();
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::CreateControls( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::DestroyControls( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::OnApplyChanges( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCCreateServerDialog::IsRandomMapSelected()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CTDCCreateServerDialog::GetMapName()
{
...
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::SetMap( const char *mapName )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::LoadMaps( const char *pszPathID )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::LoadMapList( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
int CTDCCreateServerDialog::GetMaxPlayers( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CTDCCreateServerDialog::GetPassword( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CTDCCreateServerDialog::GetHostName( void )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
const char *CTDCCreateServerDialog::GetValue( const char *cvarName, const char *defaultValue )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::LoadGameOptionsList( void )
{
	...
	while ( pObj )
	{
		...
		{
		case O_BOOL:
			pBox = new CTDCCheckButton( pCtrl, "DescCheckButton", pObj->prompt );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCCreateServerDialog::GatherCurrentValues( void )
{
	if ( !m_pDescription )
		return;
