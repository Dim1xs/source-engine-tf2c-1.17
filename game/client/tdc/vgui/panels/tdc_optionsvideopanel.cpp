...
// Purpose: 
//-----------------------------------------------------------------------------
CTDCOptionsVideoPanel::CTDCOptionsVideoPanel( vgui::Panel *parent, const char *panelName ) : CTDCDialogPanelBase( parent, panelName )
{
	m_pListPanel = new CPanelListPanel( this, "PanelListPanel" );
}

void CTDCOptionsVideoPanel::CreateControls()
{
	...
	m_pGammaSlider = new CTDCCvarSlider( this, "Gamma", 1.6f, 2.6f, "mat_monitorgamma", true );
	...
	m_pFOVSlider = new CTDCCvarSlider( this, "FOV", 90.0f, MAX_FOV, "fov_desired" );
...
void CTDCOptionsVideoPanel::DestroyControls()
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::ApplySchemeSettings( IScheme *pScheme )
{
...
void CTDCOptionsVideoPanel::OnCommand( const char* command )
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::PrepareResolutionList()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
CTDCOptionsVideoPanel::~CTDCOptionsVideoPanel()
{
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::OnResetData()
{
...
void CTDCOptionsVideoPanel::ResetDXLevelCombo()
{
	ConVarRef mat_dxlevel( "mat_dxlevel" );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::SetCurrentResolutionComboItem()
{
	vmode_t *plist = NULL;
	int count = 0;
	gameuifuncs->GetVideoModes( &plist, &count );
...
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::OnApplyChanges()
{
...
void CTDCOptionsVideoPanel::MarkDefaultSettingsAsRecommended()
{
...
void CTDCOptionsVideoPanel::ApplyChangesToConVar( const char *pConVarName, int value )
{
...
void CTDCOptionsVideoPanel::SetComboItemAsRecommended( vgui::ComboBox *combo, int iItem )
{
	// get the item text
	wchar_t text[512];
...
int CTDCOptionsVideoPanel::FindMSAAMode( int nAASamples, int nAAQuality )
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::OnTextChanged( Panel *pPanel, const char *pszText )
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsVideoPanel::OnControlModified()
{
...
//-----------------------------------------------------------------------------
bool CTDCOptionsVideoPanel::RequiresRestart()
{
	// make sure there is a change
