...
char* CTDCOptionsAudioPanel::m_pchUpdatedAudioLanguage = (char*)GetLanguageShortName( k_Lang_English );
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CTDCOptionsAudioPanel::CTDCOptionsAudioPanel( vgui::Panel *parent, const char *panelName ) : CTDCDialogPanelBase( parent, panelName )
{
...
// Purpose: Destructor
//-----------------------------------------------------------------------------
CTDCOptionsAudioPanel::~CTDCOptionsAudioPanel()
{
}
...
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::ApplySchemeSettings( IScheme *pScheme )
{
...
void CTDCOptionsAudioPanel::CreateControls()
{
	BaseClass::CreateControls();

	Label *pTitleVolume = new Label( this, "DescTextTitle", "Volume" );
	m_pSFXSlider = new CTDCCvarSlider( this, "SFXSlider", 0.0f, 1.0f, "volume", true );
	m_pMusicSlider = new CTDCCvarSlider( this, "MusicSlider", 0.0f, 1.0f, "Snd_MusicVolume", true );
	...
	m_pReceiveVolume = new CTDCCvarSlider( this, "VoiceReceive", 0.0f, 1.0f, "voice_scale" );
	m_pVoiceEnableCheckButton = new CTDCCvarToggleCheckButton( this, "voice_modenable", "#GameUI_EnableVoice", "voice_modenable" );
...
void CTDCOptionsAudioPanel::DestroyControls()
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::OnResetData()
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::OnApplyChanges()
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::OnControlModified()
{
...
// Purpose:
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::OnTextChanged()
{
	OnControlModified();
}
...
//-----------------------------------------------------------------------------
bool CTDCOptionsAudioPanel::RequiresRestart()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::OnCommand( const char *command )
{
...
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::RunTestSpeakers()
{
...
//-----------------------------------------------------------------------------
class CTDCOptionsAudioPanelThirdPartyCreditsDlg : public vgui::Frame
{
	DECLARE_CLASS_SIMPLE( CTDCOptionsAudioPanelThirdPartyCreditsDlg, vgui::Frame );
public:
	CTDCOptionsAudioPanelThirdPartyCreditsDlg( vgui::VPANEL hParent ) : BaseClass( NULL, NULL )
	{
...
//-----------------------------------------------------------------------------
void CTDCOptionsAudioPanel::OpenThirdPartySoundCreditsDialog()
{
	if ( !m_OptionsSubAudioThirdPartyCreditsDlg.Get() )
	{
		m_OptionsSubAudioThirdPartyCreditsDlg = new CTDCOptionsAudioPanelThirdPartyCreditsDlg( GetVParent() );
	}
