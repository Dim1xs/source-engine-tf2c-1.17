...
//-----------------------------------------------------------------------------
class CTDCOptionsKeyboardPanel : public CTDCDialogPanelBase
{
	DECLARE_CLASS_SIMPLE(CTDCOptionsKeyboardPanel, CTDCDialogPanelBase);

public:
	CTDCOptionsKeyboardPanel(vgui::Panel* parent, const char *panelName);
	~CTDCOptionsKeyboardPanel();
...
private:
	...
	vgui::DHANDLE<class CTDCOptionsKeyboardPanelAdvancedDlg> m_OptionsSubKeyboardAdvancedDlg;
	virtual void OnKeyCodeTyped(vgui::KeyCode code);

	vcontrolslistpanel	*m_pKeyBindList;

	CTDCButton *m_pSetBindingButton;
	CTDCButton *m_pClearBindingButton;
