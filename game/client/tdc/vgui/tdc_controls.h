...
#ifndef TDC_CONTROLS_H
#define TDC_CONTROLS_H
#ifdef _WIN32
#pragma once
#endif
...
private:
	...
	CTDCImagePanel		*m_pUpArrow;
	vgui::ImagePanel	*m_pLine;
	CTDCImagePanel		*m_pDownArrow;
...
//-----------------------------------------------------------------------------
class CTDCFooter : public vgui::EditablePanel
{
	DECLARE_CLASS_SIMPLE( CTDCFooter, vgui::EditablePanel );

public:
	CTDCFooter( Panel *parent, const char *panelName );
	virtual ~CTDCFooter();
