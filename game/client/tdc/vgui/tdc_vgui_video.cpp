...
DECLARE_BUILD_FACTORY( CTDCVideoPanel );

//-----------------------------------------------------------------------------
// 
//-----------------------------------------------------------------------------
CTDCVideoPanel::CTDCVideoPanel( vgui::Panel *parent, const char *panelName ) : VideoPanel( 0, 0, 50, 50 )
{
	SetParent( parent );
...
// 
//-----------------------------------------------------------------------------
void CTDCVideoPanel::ReleaseVideo()
{
...
// 
//-----------------------------------------------------------------------------
void CTDCVideoPanel::ApplySettings( KeyValues *inResourceData )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCVideoPanel::GetPanelPos( int &xpos, int &ypos )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCVideoPanel::OnVideoOver()
{
...
//-----------------------------------------------------------------------------
bool CTDCVideoPanel::BeginPlaybackNoAudio(const char *pFilename)
{
