...
#ifndef TDC_OVERVIEW_H
#define TDC_OVERVIEW_H

#include <mapoverview.h>
#include "tdc_shareddefs.h"

class CTDCMapOverview : public CMapOverview
{
	DECLARE_CLASS_SIMPLE( CTDCMapOverview, CMapOverview );

	CTDCMapOverview(const char *pElementName);
...
#define TDC_MAP_ZOOM_LEVELS	2
};

extern CTDCMapOverview *GetTDCOverview( void );

#endif // TDC_OVERVIEW_H
