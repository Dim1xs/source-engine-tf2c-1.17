...
CTDCMapOverview *GetTDCOverview( void )
{
	return dynamic_cast<CTDCMapOverview *>( g_pMapOverview );
}
...
DECLARE_HUDELEMENT( CTDCMapOverview );
...
// Purpose: 
//-----------------------------------------------------------------------------
CTDCMapOverview::CTDCMapOverview(const char *pElementName) : CMapOverview(pElementName)
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::VidInit( void )
{
	BaseClass::VidInit();
}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::UpdateCapturePoints()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::InitTeamColorsAndIcons()
{
	BaseClass::InitTeamColorsAndIcons();

	m_TeamColors[TDC_TEAM_RED] = COLOR_TDC_RED;
	m_TeamIcons[TDC_TEAM_RED] = AddIconTexture( "sprites/minimap_icons/red_player" );
	m_CameraIcons[TDC_TEAM_RED] = AddIconTexture( "sprites/minimap_icons/red_camera" );

	m_TeamColors[TDC_TEAM_BLUE] = COLOR_TDC_BLUE;
	m_TeamIcons[TDC_TEAM_BLUE] = AddIconTexture( "sprites/minimap_icons/blue_player" );
	m_CameraIcons[TDC_TEAM_BLUE] = AddIconTexture( "sprites/minimap_icons/blue_camera" );
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::DrawCamera()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::FireGameEvent( IGameEvent *event )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCMapOverview::CanPlayerBeSeen( MapPlayer_t *player )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::ShowLargeMap( void )
{
	if ( IsDisabled() )
	{
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::HideLargeMap( void )
{
	if ( IsDisabled() )
	{
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::ToggleZoom( void )
{
	if ( IsDisabled() )
	{
		return;
	...
	int iZoomLevel = ( _cl_minimapzoom.GetInt() + 1 ) % TDC_MAP_ZOOM_LEVELS;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::SetMode(int mode)
{
	if ( IsDisabled() )
	{
		return;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::UpdateSizeAndPosition()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::PlayerChat( int index )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::DrawMapPlayers()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::DrawVoiceIconForPlayer( int playerIndex )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCMapOverview::DrawIcon( MapObject_t *obj )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::DrawQuad( Vector pos, int scale, float angle, int textureID, int alpha )
{
	Vector offset;
	offset.z = 0;
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCMapOverview::DrawCapturePoint( int iCP, MapObject_t *obj )
{
	...
	if ( iCappingTeam != TEAM_UNASSIGNED )
	{
		...
		bool bSwipeLeft = ( iCappingTeam == TDC_TEAM_RED ) ? true : false;
	...
	int iNumBlue = g_pObjectiveResource->GetNumPlayersInArea( iCP, TDC_TEAM_BLUE );
	int iNumRed = g_pObjectiveResource->GetNumPlayersInArea( iCP, TDC_TEAM_RED );

	int iOwningTeam = g_pObjectiveResource->GetOwningTeam( iCP );
	if ( iCappingTeam == TEAM_UNASSIGNED )
	{
		if ( iNumBlue > 0 && iNumRed == 0 && iOwningTeam != TDC_TEAM_BLUE )
		{
			iCappingTeam = TDC_TEAM_BLUE;
		}
		else if ( iNumRed > 0 && iNumBlue == 0 && iOwningTeam != TDC_TEAM_RED )
		{
			iCappingTeam = TDC_TEAM_RED;
		}
	}
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::DrawHorizontalSwipe( Vector pos, int scale, int textureID, float flCapPercentage, bool bSwipeLeft )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::SetMap( const char * levelname )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
bool CTDCMapOverview::ShouldDraw( void )
{
	if ( IsDisabled() )
	{
		return false;
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::DrawMapOverlayTexture()
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CTDCMapOverview::UpdateMapOverlayTexture()
{
...
/*
	...
	if ( wide != tall )
	{
		DevMsg( 1, "Error! CTDCMapOverview::UpdateMapOverlayTexture: map overlay image must be a square.\n" );
		m_nMapTextureOverlayID = -1;
		return;
	}
*/
