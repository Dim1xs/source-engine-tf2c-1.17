...
struct ClassStats_t
{
	...
	ClassStats_t()
	{
		iPlayerClass	= TDC_CLASS_UNDEFINED;
		iNumberOfRounds = 0;
	}
...
class CTDCStatPanel : public vgui::EditablePanel, public CHudElement
{
private:
	DECLARE_CLASS_SIMPLE( CTDCStatPanel, vgui::EditablePanel );

public:
	CTDCStatPanel( const char *pElementName );
	virtual ~CTDCStatPanel();
	...
	void OnLocalPlayerRemove( C_TDCPlayer *pPlayer );
