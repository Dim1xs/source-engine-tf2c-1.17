...
//-----------------------------------------------------------------------------
void TDC_ThrowCigaretteCallback( const CEffectData &data )
{
	...
	pTemp->m_nSkin = GetTeamSkin( iTeam );
...
DECLARE_CLIENT_EFFECT( "TDC_ThrowCigarette", TDC_ThrowCigaretteCallback );